...
import BlogDetailImg from "../../../assets/img/blog-detail.jpg";
  ...
  return (
    <div className="post-detail__content">
      <div className="thumbnail">
        <img src={BlogDetailImg} alt="blog-title" />
      </div>
      ...
      <div className="content-padding">
        <div className="rte">
          <p>
            ...
            but the original tool by the same name only supports HTML. Markdown
